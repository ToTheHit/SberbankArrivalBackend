...
//                    if (distance < maxDistance) {
                        ...
                        newClient.put("trackTitle", socket.getTitle());
                        newClient.put("trackAuthor", socket.getArtist());
                        newClient.put("artwork150", socket.getArtwork());
...
/*                data.getUser(),
                ...
                tmp_track.getString("artworkUrl100").replaceAll("160", "300"),
